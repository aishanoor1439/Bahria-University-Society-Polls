        ...
        <div class="col-md-8 col-lg-6">
            <div class="card login-card animate__animated animate__fadeIn">
                <div class="card-body p-md-5">
                    ...
                    <form action="{{ route('admin.register.submit') }}" method="POST" class="animate__animated animate__fadeIn animate__delay-1s">
                        @csrf

                        <div class="form-outline mb-4">
                            <label class="form-label" for="form2Example11"><i class="fas fa-user me-2"></i>Username</label>
                            <input type="text" id="form2Example11" class="form-control" name="name" placeholder="Enter your username" required />
                        </div>

                        <div class="form-outline mb-4">
                            <label class="form-label" for="form2Example22"><i class="fas fa-envelope me-2"></i>Email</label>
                            <input type="email" id="form2Example22" class="form-control" name="email" placeholder="example@gmail.com" required />
                        </div>

                        <div class="form-outline mb-4 password-input-container">
                            <label class="form-label" for="form2Example33"><i class="fas fa-lock me-2"></i>Password</label>
                            <input type="password" id="form2Example33" class="form-control" name="password" placeholder="Create a strong password" required />
...
<script>
    function togglePasswordVisibility() {
        const passwordInput = document.getElementById('form2Example33');
