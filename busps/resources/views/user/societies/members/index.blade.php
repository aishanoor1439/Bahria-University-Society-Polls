...
@section('title', 'Manage Society Members')
    ...
    <div class="card-body">
        ...
        @if($members->isEmpty())
            <div class="alert alert-danger">
                <i class="fas fa-info-circle"></i> No members have been added yet.
            </div>
        @else
            <table class="table">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('societies.members.destroy', [$society->society_id, $member->student_id]) }}">
                                @csrf @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm"><i class="fas fa-user-minus"></i>
                                    Remove
                                </button>
                            </form>
                        </td>
