        ...
        <div class="col-md-8 col-lg-6">
            <div class="card login-card animate__animated animate__fadeIn">
                <div class="card-body p-md-5">
                    ...
                    <form action="{{ route('user.login.submit') }}" method="POST" class="animate__animated animate__fadeIn animate__delay-1s">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{ route('user.password.request') }}" style="color: var(--primary-color);">Forgot password?</a>
                        </div>
